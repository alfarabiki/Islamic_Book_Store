...
Partial Class AlQuran
    ...
    Sub loaddata(ByVal item_id As String)
        Dim data = (From a In db.tITEMs
                    ...
                    From c In db.tCODEs.Where(Function(c) c.C_CODE = a.ITEM_UNIT).DefaultIfEmpty
    ...
    Protected Sub btnAddToCart_Click(sender As Object, e As EventArgs) Handles btnAddToCart.Click
        If Qty.Value > 0 Then
            ...
            Try
                ...
                db.SaveChanges()
                Response.Redirect("~/AlQuran.aspx?ITEM_ID=" & Request("ITEM_ID").ToString)
