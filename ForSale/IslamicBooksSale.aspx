<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="IslamicBooksSale.aspx.vb" Inherits="ForSale_IslamicBooksSale" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <fieldset style="border-color: #E5E5E5;">
        ...
        <table style="width: 100%">
            <tr>
                <td style="padding-left: 5px; padding-top: 5px; width: 420px; vertical-align: top">
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td colspan="3" style="padding-left: 2px; padding-bottom: 10px; font-weight: bold; font-size: larger">
                                <asp:Label ID="lblTitlebook" runat="server"></asp:Label></td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td style="margin: 50px; float: right">
                                <h1 class="gradation" style="color: #368EE0">Harga :
                                    <asp:Label ID="lblprice" runat="server" Text="10.0000"></asp:Label></h1>
                            </td>
                        </tr>
                        <tr>
