<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="IslamicBooksBorrow.aspx.vb" Inherits="ForBorrow_IslamicBooksBorrow" %>
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td style="margin: 50px; float: right">
                                <h1 class="gradation" style="color: #368EE0">Silahkan dipinjam selama ada stock</h1>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding-left: 20px; float: Left">
                                <div>
                                    Jumlah Peminjaman : 
                                <telerik:RadNumericTextBox ID="Qty" runat="server" MaxValue="1" MinValue="0" Width="50" DisplayText="0"
