<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="CartDetail.aspx.vb" Inherits="CartDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <fieldset style="border-color: #E5E5E5;">
                        ...
                        <tr>
                            <td>
                                <telerik:RadTextBox ID="rtbLabel5" runat="server" Font-Size="Large" Enabled="false" ForeColor="Black"
                                    BorderColor="Transparent" BackColor="Transparent" Text="Total Pembelian" Width="150">
                                </telerik:RadTextBox>
                            </td>
                            <td>
                            ...
                            <td>
                                <telerik:RadTextBox ID="rtbJumlahPembelian" runat="server" Width="100%" Font-Size="Large" Enabled="false" ForeColor="Black"
                                    BorderColor="Transparent" BackColor="Transparent">
                                </telerik:RadTextBox>
                            </td>
                        </tr>
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td style="margin-top: 50px; margin-bottom: 50px; margin-left: 40px; float: Left">
                                <asp:Button ID="btnBack" runat="server" Text="      Back     " PostBackUrl="~/Cart.aspx" BackColor="#368EE0" />
                            </td>
        ...
        <asp:SqlDataSource ID="dsDocument" runat="server" SelectCommandType="StoredProcedure"
            ...
            <SelectParameters>
                <asp:ControlParameter Name="ITEM_ID" ControlID="lblItem_id" DbType="String" />
            </SelectParameters>
        </asp:SqlDataSource>
